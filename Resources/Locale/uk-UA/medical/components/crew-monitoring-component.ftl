...
crew-monitoring-ui-filter-line-placeholder = Фільтр

crew-monitoring-ui-job-label = Посада:
crew-monitoring-ui-no-server-label = Сервер не знайдено

crew-monitoring-ui-no-department-label = Невідомо
