...
drain-component-unclog-fail = { CAPITALIZE($object) } досі забитий
drain-component-unclog-success = { CAPITALIZE($object) } прочищено.
drain-component-unclog-notapplicable = { CAPITALIZE($object) } не забитий.
