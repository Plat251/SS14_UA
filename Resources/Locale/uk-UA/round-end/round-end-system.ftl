...
round-end-system-shuttle-auto-called-announcement = Автоматичний евакуаційний шатл був відправлений. Oрієнтовний час прибуття: {$time} {$units}. Скасуйте шатл для подовження робочої зміни.
